...
function updateGame(dt)
	...
	if gameSettings.eraserMode and love.mouse.isDown(1) then
			for i=shapes.n,1,-1 do
		...
		if gameSettings.pencilMode and love.mouse.isDown(1) and gameSettings.x > 0 and gameSettings.x < gameSettings.fieldWidth*gameSettings.size and gameSettings.y > 0 and gameSettings.y < gameSettings.fieldHeight*gameSettings.size then
	...
	bM:update(dt, love.mouse.getX(), love.mouse.getY(),love.mouse.isDown(1))
...
function updateGameOver(dt)
	...
	bMGO:update(dt, love.mouse.getX(), love.mouse.getY(),love.mouse.isDown(1))
end

function updateMenu(dt)
	gameData.realTime = gameData.realTime + dt
	animatedBG:update(dt, love.mouse.getX(), love.mouse.getY(),love.mouse.isDown(1))
	bMMenu:update(dt, love.mouse.getX(), love.mouse.getY(),love.mouse.isDown(1))
end

function updateOptions(dt)
	gameData.realTime = gameData.realTime + dt
	animatedBG:update(dt, love.mouse.getX(), love.mouse.getY(),love.mouse.isDown(1))
	bMOpt:update(dt, love.mouse.getX(), love.mouse.getY(),love.mouse.isDown(1))
end
